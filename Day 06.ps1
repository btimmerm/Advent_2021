...
Class LFSchool {
    ...
    [void] hidden UpdateTotal () {
        $this.Total = ($this.LifeCycle | Measure-Object -Sum).Sum
    }
}
...
$LanternFish = [LFSchool]::New($Data)
$LanternFish.Live(18)

# Example: 26
# Puzzle:  1743

$Answer_Puzzle_1 = $LanternFish.Live(80 - $LanternFish.Days)
$Answer_Puzzle_1
